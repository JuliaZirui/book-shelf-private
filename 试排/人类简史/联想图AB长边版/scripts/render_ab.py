...
REASONS=['从自然选择出发，\n理解人类演化','从基因视角，\n对照文化的作用','从地理与环境，\n解释文明差异','延伸历史视野，\n追问科技与未来']
LONG_EDGE=216;STROKE=2;RADIUS=24
GEOMETRY={}
...
def a():
 ...
 line(p,[(360,570),(254,570)])
 line(p,[(720,890),(826,890)])
 line(p,[(660,main[1]),(660,424)])
 arc(p,(684,424),180,270)
 line(p,[(684,400),(808,400)])
 line(p,[(420,main[3]),(420,1036)])
 arc(p,(396,1036),0,90)
 line(p,[(396,1060),(272,1060)])
...
if __name__=='__main__':
 ...
 for i,(im,label) in enumerate(zip(ims,['A 错位放射 · 圆角正交','B 共用主干 · 无箭头'])):
